...
import { Dimensions, FlatList, KeyboardAvoidingView, Platform, RefreshControl, ScrollView, Text, TouchableOpacity, View } from 'react-native'
...
const Home = (props) => {
	...
	const separator = () => ( <View style={{height: 1, backgroundColor: 'gray'}} ></View> );
	...
	return (
		<View style={style.container}>
			<ScrollView
				refreshControl={ <RefreshControl tintColor={"#fff"} refreshing={refresh} onRefresh={() => refreshData()}/> }
			>
				...
				<>	
					...
					{chats.map((e) => {
						return (
							<>
								<RenderItem idChat={e.Usr_Chat} apelido={e.UsrC_Apelido}/>
